...
- `About` introduces the lab
- `MAKES` should foreground the real runtime work
- `DEV LOG` can remain empty until real writing is published

## Runtime Surface Rule

- TAIGA face should be presented as part of the HAMPTER LAB site shell, not as a disconnected external tool
