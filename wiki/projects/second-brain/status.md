...
- The wiki now contains a parent project `hampter`, a TAIGA parent project under it, and the `taiga-face` and `signage` subprojects inside TAIGA.
...
- Keep the project hierarchy explicit as more HAMPTER work is added.
